...
public class Mesh_To_PolygonCollider : MonoBehaviour {
	...
	void OnDrawGizmos()
	{
		...
		for (int i = 0; i < points.Count - 1; i++)
		{
			...
			pointA = polygonCollider.transform.TransformPoint(pointA);
			pointB = polygonCollider.transform.TransformPoint(pointB);
